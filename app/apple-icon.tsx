...
/**
 * El icono que usa iOS cuando alguien agrega el sitio a la pantalla de inicio
 * —guardarse la página de un negocio para volver a reservar es exactamente lo
 * que queremos que pase—, y el que Safari muestra en los favoritos.
 *
 ...
 *
 * El icono es el de Polaria y no el del negocio guardado. Es una limitación
 * conocida y se levanta el día que haga falta: un `apple-icon.tsx` dentro de
 * `[businessSlug]` le daría a cada negocio el suyo.
 *
