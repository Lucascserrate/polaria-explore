		...
		<section className="relative overflow-hidden bg-ink-950 pb-20 pt-28 text-white sm:pb-24 sm:pt-32">
			...
			<Container width="wide" className="relative">
              ...
              primer scroll. */}
				...
				<div
					id={sectionIds.simulador}
					tabIndex={-1}
					className="mt-14 scroll-mt-24 outline-none sm:mt-16"
				>
...
function AuroraBackdrop() {
	return (
		...
		>
			...
			<div className="absolute left-1/2 -top-80 h-136 w-208 -translate-x-1/2 rounded-full bg-[radial-gradient(closest-side,rgb(31_107_255/0.38),transparent)] blur-3xl motion-safe:animate-aurora" />
			<div className="absolute -right-48 top-32 h-104 w-104 rounded-full bg-[radial-gradient(closest-side,rgb(139_92_246/0.2),transparent)] blur-3xl" />
			<div className="absolute -bottom-56 -left-32 h-96 w-[24rem] rounded-full bg-[radial-gradient(closest-side,rgb(34_211_238/0.14),transparent)] blur-3xl" />
		</div>
	);
}
