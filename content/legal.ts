  ...
  sections: [
    {
      ...
      paragraphs: [
        `${site.legal.entity}, con domicilio en ${site.legal.city}, ${site.legal.country}, es responsable del tratamiento de los datos descritos en esta política. Podés contactarnos en ${site.contactEmail} para cualquier consulta relacionada.`,
    ...
    },
    {
      ...
      paragraphs: ["Tratamos únicamente lo necesario para atender la conversación y gestionar la cita:"],
      bullets: [
    ...
    },
    {
      title: "Tus derechos",
      paragraphs: [
        `Podés pedirnos acceso a tus datos, su corrección, su eliminación o la limitación de su tratamiento escribiendo a ${site.contactEmail}. Respondemos dentro de los treinta días.`,
...
export const terms: { title: string; intro: string; sections: LegalSection[] } = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        `Podemos actualizar estos términos. Los cambios relevantes se comunican a los negocios activos por correo. Para cualquier consulta, escribinos a ${site.contactEmail}.`,
      ],
    },
  ],
};
