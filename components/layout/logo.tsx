 ...
 *
 * Es el mismo glifo que usan el panel y la landing, así que los tres sitios
 * abren con la misma firma. **Está duplicado a propósito**: son tres
 * despliegues distintos y no hay paquete compartido; el precio de compartirlo
 * sería atar el build de este sitio al código de otro repositorio. Cuando
 * llegue el logo definitivo se reemplaza este archivo, igual que su gemelo.
 */
